    ...
    <div className="mt-5">
      <div className="md:p-10 p-5 top-5 w-full items-center">
        <div className="flex justify-between text-gray-500 items-center">
          <h1 className="md:text-4xl text-2xl font-bold">Electronic Products</h1>
            ...
            {TBDeal.length > 0 && TBDeal ? (
              TBDeal.map((item) => (
                ...
                >
                  ...
                  <FontAwesomeIcon
                    icon={faHeart}
                    className={`text-2xl justify-center absolute top-3 right-5 ${item.heart ? 'text-red-600' : 'text-gray-500'}`}
                  />
