        ...
        <div className="grid md:grid-cols-4 grid-cols-1 bg-white gap-5">
          <div className="md:col-span-1 m-5">
            <div className="grid gap-5">
              ...
              <div className="shadow-xl px-5 py-10 rounded-xl  font-bold text-[#0B60A8] flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-5">
                <div className="flex gap-5 items-center">
                  ...
                  <span className="flex gap-10 text-sm font-bold text-[#0B60A8]">
                    ...
                    <span className="cursor-pointer" onClick={() => setIsOpen(!isOpen)}>Change Password</span>
                  </span>
                </div>
                <input
                  type="email"
              ...
              <div>
                <p className="font-bold text-[#505050] mt-3">
                  ...
                  (or mobile number) doesn't invalidate your account. Your
                ...
                <div className="fixed inset-0 bg-transparent flex items-center justify-center z-50 backdrop-blur-[1px]">
                  <div className="bg-white shadow-lg w-[90%] md:w-[600px] flex">
                    ...
                    <div className="p-5 w-full md:w-1/2 flex flex-col space-y-4">
                      ...
                      <button className="bg-blue-800 text-white p-3 rounded-xl font-bold" onClick={() => window.alert('Password Change Successfully...') || setIsOpen(false)}>
                        Change Password
                      </button>
                      <button
                        onClick={() => setIsOpen(false)}
